...
//   FL — educationHours 60 (2-15 Life/Health course), exam 150 scored/165min/70%/$44,
//        applicationFee $50, licenseFee $5  https://www.pearsonvue.com/content/dam/VUE/vue/en/documents/publications/121000.pdf
//   GA — applicationFee $120  https://oci.georgia.gov/get-insurance-agent-license
...
//   TN — examFee $80 combined L&H (Pearson VUE TN page)  https://home.pearsonvue.com/tn/insurance
...
export const insurance_agent_lhRequirements: LicenseRequirements[] = [
  ...
  // Florida
  {
    ...
    educationHours: 60, ageMinimum: 18, backgroundCheck: true,
    examVendor: pearson,
    exam: { nationalQuestions: 150, timeLimitMin: 165, passingPct: 70, examFee: 44 },
